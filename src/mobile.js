...
//Checking the Iphone Price by its Features
let iphones = new IPhone('Xioami', '3GB', '3000MaH', '24000')
iphones.displayFeatures()
console.log(iphones.remainingAmount(30000))
